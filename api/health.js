...
module.exports=async function handler(req,res){
 const out={ok:true,version:'v15.5-rescue',apiFootball:!!process.env.API_FOOTBALL_KEY,supabase:db.configured(),cronSecret:!!process.env.CRON_SECRET,softCap:Number(process.env.API_DAILY_SOFT_CAP||6500),hardCap:Number(process.env.API_DAILY_HARD_CAP||7400)};
